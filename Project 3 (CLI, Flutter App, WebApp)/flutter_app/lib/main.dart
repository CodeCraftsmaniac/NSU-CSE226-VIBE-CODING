...
const defaultApiBaseUrl = String.fromEnvironment(
  'API_BASE_URL',
  defaultValue: 'https://nsu-degree-audit-engine-9q9jhsig0-adamjeeans-projects.vercel.app',
);
            ...
            children: [
              ...
              const Wrap(
                ...
                children: [
                  ...
                  FeatureChip(icon: Icons.workspace_premium, label: 'Premium mobile presentation'),
                ],
              ),
              ...
              GlassTone(
                child: Row(
                  children: [
                    ...
                    Expanded(child: Text(apiBaseUrl, style: theme.textTheme.bodyLarge?.copyWith(color: Colors.white))),
                  ],
                ),
              ),
              const SizedBox(height: 18),
