...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#  ENGINE  ·  Program Detection (used by CLI, Web, Flutter backend)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
...
def detect_program(courses):
    ...
    Args:
        courses: List of dicts with 'code' key

    Returns:
        Program key ('CSE', 'LLB', 'BBA', etc.) or None
    """
    if not courses:
        return None
...
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━
#  ENGINE  ·  Full 3-Level Analysis (used by CLI, Web, Flutter backend)
# ━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━

def run_full_analysis(courses_raw, kb_path=None):
    """Run all 3 levels of analysis on OCR-extracted courses.

    This is THE single source of truth for analysis logic.
    CLI, Web App, and Flutter backend all call this function.

    Args:
        courses_raw: List of dicts with keys: course_code, credits, grade, semester
        kb_path: Optional path to knowledge_base.md for Level 3 audit

    Returns:
        Dict with keys: level1, level2, level3, courses, semesters
    """
    ...
    courses = [
        ...
        if c.get('course_code') and c.get('grade')
    ]
    ...
    if kb_path and os.path.isfile(kb_path) and detected_program:
        try:
    ...
    # Fallback: show detected program even without KB
